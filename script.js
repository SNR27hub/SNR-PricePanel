...
const handleUtrSubmission = async (e, projectId) => {
    ...
    try {
        ...
        // This is the critical step that needs the Firestore rules to be correctly set.
        ...
        utrErrorEl.textContent = `Error submitting UTR. Please try again. (${error.message})`; // Show error message from Firebase
        utrErrorEl.style.color = "var(--danger-color)";
    } finally {
